class pantallas {
  ...
  PantallaDerrota() {
    ...
    textSize(20);
    text("¡Oh no! ¡El lobo te ha alcanzado!", width/2, height/2 + 30);
    fill(255,255,0);
    stroke (0)
    strokeWeight(5)
    text("Presiona R para jugar de nuevo", width/2, height/2 + 60);
    textAlign(LEFT);
  }
  ...
  PantallaVictoria() {
    ...
    textSize(20);
    text("¡Has podido escapar del lobo!", width/2, height/2 + 30);
    fill(255,255,0);
    text("Presiona R para jugar de nuevo", width/2, height/2 + 60);
    textAlign(CENTER);
    noStroke();
